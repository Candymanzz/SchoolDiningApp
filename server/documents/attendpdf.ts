...
const generateAttendanceReport = ({ date, classx, students, attendance }: ReportData): string => {
    const attendanceMap: Record<string, boolean | null> = attendance.reduce((acc, record) => {
